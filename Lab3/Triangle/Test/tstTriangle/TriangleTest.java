...
public class TriangleTest {
	...
	@Test
		...
		parameterC = 14;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
		assertEquals(78.926786, triangle.getSquare(), 0.000001);
	}
	
	@Test
	public void getSquare_Zero_A_tst(){
		parameterA = 0;
		parameterB = 12;
		parameterC = 14;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
	...
	@Test
	public void getSquare_Equilateral_tst() {
		parameterA = 5;
		parameterB = 5;
		parameterC = 5;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
		assertEquals(10.825318, triangle.getSquare(), 0.000001);
	}

	@Test
	public void getSquare_Rectangular_tst() {
		parameterA = 3;
		parameterB = 4;
		parameterC = 5;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
		assertEquals(6, triangle.getSquare(), 0.000001);
	}

	@Test
	public void getSquare_Isosceles_tst(){
		parameterA = 2;
		parameterB = 2;
		parameterC = 3;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
		assertEquals(1.984313, triangle.getSquare(), 0.000001);
	}

	@Test
	public void getSquare_Negative_A_tst() {
		parameterA = -15;
		parameterB = 12;
		parameterC = 14;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
